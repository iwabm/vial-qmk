...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BASE] = LAYOUT_full_backspace(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,   MO(_FN),      KC_SPACE,          KC_RGUI,  KC_LEFT, KC_DOWN, KC_RIGHT
    ),
     ...
     *         
     */
    [_LN] = LAYOUT_full_backspace(
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    _______,  _______,  _______,  KC_MPRV,  KC_MNXT,
