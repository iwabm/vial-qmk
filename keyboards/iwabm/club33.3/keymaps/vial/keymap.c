...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├────┬─┴──┬┴───┴┬──┴───┴─┬─┴───┴──┬┴───┼───┤───┤───┤
     * │LCtl│LAlt│LGUI │  Space │ MO(1)  │RGUI│ ← │ ↓ │ → │
     * └────┴────┴─────┴────────┴────────┴────┴───┴───┴───┘
     *                                               
     */
    [_BASE] = LAYOUT(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,  KC_SPACE,   MO(_FN),  KC_RGUI, KC_RALT,  KC_LEFT, KC_DOWN, KC_RIGHT
    ),
     ...
     */
    [_FN] = LAYOUT(
        _______,  KC_EXLM,  KC_AT,    KC_HASH,  KC_DLR,  KC_PERC,  KC_CIRC,  KC_AMPR,  KC_ASTR,  KC_LBRC,  KC_RBRC,  KC_BSLS,   _______,
        _______,  KC_1,     KC_2,     KC_3,     KC_4,    KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     _______,    
        _______,  KC_LPRN,  KC_RPRN,  KC_SCLN,  KC_DOT,  _______,  KC_MINS,  KC_PLUS,  KC_ASTR,  KC_SLSH,  KC_EQL,   _______,
        _______,  _______,  _______,            _______,           _______,  _______,  _______,  _______,  _______,   _______
    ),

    /* ALTERNATE Function layer (MOMENTARY)
     * ┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬──────┐
     * │   │F1 │F2 │F3 │F4 │F5 │F6 │   │   │   │PRV│NXT   │
     * ├───┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬──┴┬─────┤
     ...
     */
    [_LN] = LAYOUT(
        _______,  KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    _______,  _______,  _______,  KC_MPRV,  KC_MNXT,_______,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][2] = {
    ...
    [_LN] =  { ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  },
};
#endif
